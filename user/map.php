<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['iframe'])){
		$updateDetails = $inst->updateiframe($_POST,$ID);
	}
	if (empty($userID)) {
...
<?php include'includes/dheader.php' ;?>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 dash_content">
          ...
          <div class="scrollmenu">
            ...
            <a href="map.php?ID=<?php echo $ID;?>"><font color="green">Map</font></a>
	...
	?>
          <form action="" method="post" enctype="multipart/form-data">
            Enter Map iframe link:
            <textarea name="iframelink" rows="6" cols="4" class="form-control"><?php echo $value['iframelink'] ?></textarea>
			<button type="submit" name="iframe" class="btn btn-default pull-right">Save</button>
            </form>
        </div>
      </div>
    </div>
