<?php
	ob_start();
	$title = "Contact - Directory of Bangladesh";
...
<div class="row">
		...
		<div class="db-content-area" style="height: auto;">

				<b>Email:</b> <?php echo $value['Email'] ?>
				<br>
				<b>	Mobile:</b> <?php echo $value['Phone'] ?>
				<br>
				<b>	Web Address:</b>  <a href="http://<?php echo $value['webAddress'] ?>" target="_blank"><?php echo $value['webAddress'] ?></a>
				<br>
