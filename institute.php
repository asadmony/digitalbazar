<?php
	ob_start();
	$title = "Institute or Company - Directory of Bangladesh";
...
<div class="container page_content">
	<div class="row">
		...
		<img src="<?php echo web_root; ?>images/InstituteCover.jpeg" alt="Cover photo is not uploaded" class="img-responsive"/>
		<?}else{?>
			<img src="<?php echo web_root; ?>user/<?php echo $value['CoverPic']; ?>" class="img-responsive">
			<?php } ?>
		</div>
	</div>
	<div class="row">
